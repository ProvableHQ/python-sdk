...
class LeoTranspiler:
    ...
    def to_leo(self, path: Path, project_name: str, model_as_input: bool = False, fixed_point_scaling_factor: Optional[int] = None):
        ...
        self.model_transpiler = _get_model_transpiler(self.model, self.validation_data, fixed_point_scaling_factor)
